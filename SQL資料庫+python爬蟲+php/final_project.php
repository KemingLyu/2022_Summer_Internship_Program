<pre>
    ...
    body{
        ...
        background-image: url('https://www.ss.net.tw/img?o=TW9uZHJpYW4wMjkuanBn');
    }
    .content{
        color: white;
        height: auto;
...
error_reporting(E_ALL & ~E_NOTICE);
    ...
    if(!$qry) $qry = "1 ";
    $qry_data = "SELECT * FROM `data` WHERE ".$qry." ORDER BY ".$sort." ".$order; 
    $qry_count = "SELECT COUNT(*) AS count FROM `data` WHERE ".$qry;
    //echo $qry_data."\n\n";
    ...
    if(mysqli_num_rows($result)==0)
        ...
        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
        {
            ...
            echo '<div class="box">';
            echo '<div class="a">';
            //echo "<a href=".$row["imglink"]."><img src=".$row["small_img"]." width='120' height='120' alt='一張圖片'></a>\n";
            echo "<a href=".$image."><img src=".$row["small_img"]." width='120' height='120' alt='一張圖片'></a>\n";
            echo "</div>";
